...
particula = CreadorParticulas([150,0],1,20000,"Fuego")
particula.add(grupo_particulas)
particula = CreadorParticulas([200,0],1,20000,"Roca")
particula.add(grupo_particulas)
particula = CreadorParticulas([300,0],1,20000,"Agua")
particula.add(grupo_particulas)
particula = CreadorParticulas([350,0],1,20000,"Arena")
particula.add(grupo_particulas)
